...
# 🛠️ Fix for SQLAlchemy/psycopg2: aggressively strip all query params
# This solves the 'pgbouncer' connection option error on Render
if "?" in DATABASE_URL:
    DATABASE_URL = DATABASE_URL.split("?")[0]

# Standardize the driver name
